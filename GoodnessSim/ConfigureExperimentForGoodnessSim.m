...
ConfigFileName=['C:\DAS\NewGenericTaylorLabCodeSummer2007\ConfigFiles\GenericCentOutEEGCoadaptiveFakeDataSimloop.config'];
...
if(fConfig==-1)
        ...
        while KeepRunningFlag 
            ...
            elseif ~isempty(findstr(line,'Data_Location'))==1
                ...
                while exist([FOutBase Subject_Code D i '.cen_out'])
                      i=num2str(1001+ str2num(i));
                      i=i(2:4);
                      if str2num(i)==999
                          D=num2str(str2num(D)-1);
                      end
 ...
 %This section reads in the program module names and the
            ...
            elseif ~isempty(findstr(line,'Funk.UpdateDecoder '))==1
                ...
                fprintf(fpCO,'Funk.RankByGoodness  \t%s\n',Funk.RankByGoodness);      
...
%                         fprintf(fpCO,'\n');
           ...
           elseif ~isempty(findstr(line,'VR.cam_fov'))==1
            ...
            elseif ~isempty(findstr(line,'Parameters.NumBlocksEarlyLimit'))==1
              ...
              %  Parameters.NumBlocksEarlyLimit =
              %  validateInputSize(Parameters.NumBlocksEarlyLimit, VR,
              %  'Parameters.NumBlocksEarlyLimit', 1)
           ...
           elseif ~isempty(findstr(line,'Parameters.BaselineFilePath '))==1
                Parameters.BaselineFilePath =line(length('Parameters.BaselineFilePath ')+1:length(line));
