...
TDT.OnTarget = 0;
TDT.ToneFreq = 800;
TDT.ToneFreqReset = 200;
TDT.ToneFreqMax = 2500;
TDT.ToneFreqInc = 200;
actualZ = -10000;
...
while WeightInitializedFlag==0 && KeepRunningFlag==1
    ...
    switch ButtonName,
        case 'Randomize',
            ...
            Parameters.EndDistance=ones(1,Parameters.NumBlocksHeld)*realmax; % time it took to finish previous blocks
...
save([OutName 'params\ParametersStart'], 'Parameters','VR', 'SigProc','decode','timing','Funk', 'data');
