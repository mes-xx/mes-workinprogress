...
%WaitForEvenFrame;
setfield(VR.world.Cursor, 'scale', [VR.CursRad VR.CursRad VR.CursRad+VR.CursRdStepSize]);
setfield(VR.world.Target, 'scale', [VR.TargRad VR.TargRad+VR.TargRdStepSize VR.TargRad ]);
setfield(VR.world.Camera, 'position', VR.camera);
VR.target_position(1)=0;%100000;
VR.cursor_position(1)=0;%10000;
