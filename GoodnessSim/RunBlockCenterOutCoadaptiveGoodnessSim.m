...
%% Delay before target is displayed
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    while ( timing.now<timing.loop_end ) && (timing.in_target_time < timing.target_hold),
        ...
        % calculate angle between deltaCursor and straight line to target
        MovementErrorAngle = acos( ...
            dot(wV,VR.target_position - VR.cursor_position) ...
            / (norm(wV) .* norm(VR.target_position - VR.cursor_position)));
