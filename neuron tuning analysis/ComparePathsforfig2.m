...
indist=45;
namelistM1=['M0109R']
%=['M0212R';'M0213R';'M0215R';'M0216R';'M0219R';'M0220R';'M0221R';'M0222R';'M0223R';'M0227R';'M0228R';'M0301R';'M0302R']%;'M0305R';'M0306R';'M0307R';'M0308R';'M0309R';'M0312R'];%'M0109R';'M0116R';'M0117R';'M0118R';'M0119R';'M0122R';'M0123R';'M0124R';'M0126R';'M0129R';'M0313R'
%namelistM1=['M0221R'];
namelist=[namelistM1]
for day=1:1%:20
    Shiftlist=[];
    ...
    totalsets=0;
    for i=3
        path=['C:\Documents and Settings\Michael\My Documents\' name(1,1:5) '\' name '0' int2str(i) '.cursor' ]
        if(exist(path)==2)
            filelist=[filelist;i];
        end
    end
    ...
    for file2=1:length(filelist)
        ...
        dat=load(['C:\Documents and Settings\Michael\My Documents\' name(1,1:5) '\' name '0' num2str(file) '.cursor']);
        ...
        TS=dat(start:r,(c-17));
        clear dat;
        dat=load(['C:\Documents and Settings\Michael\My Documents\' name(1,1:5) '\' name '.0' num2str(file) '.ascii']);
        HCPos=dat(:,1:3);
        ...
        for i=-50:5:50
            ...
            if(size(HCposinterp)==size(HCCurs))
                ...
                disp(  'HCposinterp is diff length than  HCCurs'); 
            end
        ...
        for i=1:size(startshc,1)-1
            ...
            if(ins(1))
                disp('first point of HC trajectory is in sphere');
                ins(1)=0;
                %keyboard;
            end
