...
invoke(TDT.RP, TDT.call_SetTag, [TDT.Dev{1} '.TargetPos' Parameters.ParTagSuffix], World.Target);
invoke(TDT.RP, TDT.call_SetTag, [TDT.Dev{1} '.CursorPos' Parameters.ParTagSuffix], World.Cursor);