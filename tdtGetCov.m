%tdtGetCov gets covariance from the TDT running Michael Stetner's
%synchrony detection circuit.
...
rate1 = invoke( TDT.RP, TDT.call_GetTag, [TDT.Dev{1} '.r1']);
rate2 = invoke( TDT.RP, TDT.call_GetTag, [TDT.Dev{1} '.r2']);
